        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.buttonView}>
                    {
                        this.state.pauseBtnStatus ?
                            <View style={styles.buttonContainer}> <Button style={styles.button} title="Pause Ride" onPress={this.pauseRide}/> </View> : null
                    }
                    {
                        this.state.resumeBtnStatus ?
                            <View style={styles.buttonContainer}> <Button style={styles.button} title="Resume Ride" onPress={this.resumeRide}/> </View> : null
                    }
                    {
                        this.state.endBtnStatus ?
                            <View style={styles.buttonContainer}> <Button style={styles.button} title="End Ride" onPress={this.endRide}/> </View> : null
                    }
                    {
                        this.state.startBtnStatus ?
                            <View style={styles.buttonContainer}> <Button style={styles.button} title="Start Ride" onPress={this.beginRide}/> </View> : null
                    }
                </View>
            </View>
        );
